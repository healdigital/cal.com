...
export const bookingApi = {
  ...
  create: (data: { studentProfileId: string; dateTime: string; prospectiveStudent: { name: string; email: string; question?: string } }) =>
...
export const analyticsApi = {
  track: (data: { eventType: string; profileId?: string; bookingId?: number; field?: string; metadata?: Record<string, unknown> }) =>
