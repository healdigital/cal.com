...
export function BookingWidget({ profileId, mentorName }: BookingWidgetProps) {
  ...
  return (
    <div className="th-rounded-xl th-border th-border-thotis-gray-200 th-bg-white th-p-6 th-shadow-sm">
      ...
      <p className="th-mt-1 th-text-sm th-text-thotis-gray-500">15 minutes en visio avec {mentorName}</p>
      ...
      {step === "form" && selectedSlot && (
        <form onSubmit={handleSubmit(onSubmit)} className="th-mt-4 th-space-y-3">
          ...
          <div>
            <label htmlFor="booking-name" className="th-sr-only">
              Prénom
            </label>
            <input
              id="booking-name"
          ...
          <div>
            <label htmlFor="booking-email" className="th-sr-only">
              Email
            </label>
            <input
              id="booking-email"
          ...
          <div>
            <label htmlFor="booking-question" className="th-sr-only">
              Question pour le mentor
            </label>
            <textarea
              id="booking-question"
              {...register("question")}
