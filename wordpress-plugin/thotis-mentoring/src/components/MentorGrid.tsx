...
export function MentorGrid({ initialField = "", initialLimit = 20 }: MentorGridProps) {
  ...
  return (
    <div className="th-space-y-6">
      {/* Search & Filters */}
      <div
        className="th-flex th-flex-col th-gap-3 sm:th-flex-row"
        role="search"
        aria-label="Recherche de mentors">
        <label htmlFor="mentor-search" className="th-sr-only">
        ...
        />
        <label htmlFor="mentor-field" className="th-sr-only">
          Filière
        </label>
        <select
          id="mentor-field"
        ...
        <label htmlFor="mentor-university" className="th-sr-only">
          Université
        </label>
        <select
        ...
        <label htmlFor="mentor-sort" className="th-sr-only">
          Trier par
        </label>
        <select
          id="mentor-sort"
      ...
      {error && (
        <div className="th-rounded-lg th-bg-red-50 th-p-4 th-text-center">
          <p className="th-text-sm th-text-red-600">Erreur lors du chargement des mentors.</p>
          <button
            type="button"
            onClick={() => refetch()}
