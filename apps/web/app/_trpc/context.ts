...
import type { CreateContextOptions, TRPCContext } from "@calcom/trpc/server/createContext";
...
export const getTRPCContext = async (_headers?: ReadonlyHeaders, _cookies?: ReadonlyRequestCookies) => {
  ...
  const contextOptions = {
    req: legacyReq,
    res: {} as CreateContextOptions["res"],
  } as CreateContextOptions;
  return await createContext(contextOptions, getServerSession);
};
