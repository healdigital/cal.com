  ...
  return (
    <div
      ...
      <div>
        {icon && icon}
        {image && (
          // eslint-disable-next-line @next/next/no-img-element -- imageProps uses JSX.IntrinsicElements["img"]
          <img
            src={image}
      ...
      {variant === "SidebarCard" && mediaLink && (
        <a
          ...
          {/* eslint-disable-next-line @next/next/no-img-element -- thumbnail in video overlay */}
