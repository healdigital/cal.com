...
// Unicode property escapes require ES6+ target. Constructing them from strings keeps
// TypeScript from rejecting this file when it is compiled by downstream packages with older targets.
