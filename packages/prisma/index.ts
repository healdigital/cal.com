...
import { stripCredentialKeysExtension } from "./extensions/strip-credential-keys";
...
export const customPrisma = (options?: Prisma.PrismaClientOptions) => {
  ...
  return new PrismaClient(finalOptions)
    ...
    .$extends(stripCredentialKeysExtension()) as unknown as PrismaClient;
};
...
// Raw client without the stripCredentialKeys extension.
// Use only in internal services that genuinely need credential.key (e.g., calendar sync, OAuth refresh).
export { baseClient as prismaWithCredentialKeys };
